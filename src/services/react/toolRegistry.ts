...
// ==================== Skill 工具已迁移到 coreTools.ts ====================
// load_skill 和 trigger_action 工具由 registerCoreTools() 统一注册
// 不再为每个 SKILL.md 创建独立 Tool（OpenCode 式架构）

import { skillStore } from './skills/skillStore'
import { registerCoreTools } from '../../tools'

// 应用启动时初始化 skillStore 并注册核心工具（含 load_skill / trigger_action）
